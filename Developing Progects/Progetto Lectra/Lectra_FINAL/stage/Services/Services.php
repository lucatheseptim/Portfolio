...
class LectraOrderService{
    ...
    const DELAY_ORDER_END = "productorders/customorders"; // Crea l'ordine su Lectra e lo invia direttamente al taglio
    // const DELAY_ORDER_END = "productorders/customorders/delayprocess"; // Crea l'ordine su Lectra in stato di "wait". Serve comando manuale per inviarlo al taglio
    ...
    private function getOrderReference(Order $order, ProductOrder $product): string{
        return "ORDER_".$order->id."_PROD_".$product->sequenceNumber."_TGL_".$product->grading;
    }
    /**

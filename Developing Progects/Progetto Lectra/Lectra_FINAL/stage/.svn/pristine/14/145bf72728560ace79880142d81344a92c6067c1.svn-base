...
class OrderControllerTest extends TestCase{
    ...
    public function testSaveOrderNewSuccessWithAllData(): Order{
        ...
        // $this->assertEquals($req_val_fields["codneg"], $order->salesPoint); // Lo pesca dalla sessione
    ...
    public function testSaveOrderAlredyExisting($order): void{
        ...
        // $this->assertEquals($req_val_fields["codneg"], $order_updated->salesPoint);  // Lo pesca dalla sessione

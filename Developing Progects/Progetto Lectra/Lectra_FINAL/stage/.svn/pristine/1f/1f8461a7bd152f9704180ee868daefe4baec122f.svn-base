...
class ProductOrderDettaglio extends Model{
    ...
    protected $key = "id";
    protected $fields = ["order_product_id", "tipo", "barcode", "posizione", "colore", "simbolo", "stile_testo", "testo", "prezzo", "ordine_simbolo"];
...
class RicamiOpzioni extends Model{
    protected $table = "ricami_opzioni";
    protected $key = "id";
    protected $fields = ["label", "tipo"];
}
/** Materiali **/
